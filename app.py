...
<div class="krishna-svg-box">
    <svg xmlns="http://w3.org" viewBox="0 0 400 400" width="100%" height="auto" style="border-radius: 20px; box-shadow: 0px 0px 30px #FFD700; background: #2d004d; padding: 20px;">
        ...
        <circle cx="200" cy="180" r="100" fill="none" stroke="#FFD700" stroke-width="4" stroke-dasharray="10,10" opacity="0.6"/>
        <circle cx="200" cy="180" r="115" fill="none" stroke="#ff6600" stroke-width="2" opacity="0.4"/>
        ...
        <g transform="translate(200, 290) rotate(-5)">
            <rect x="-130" y="-8" width="260" height="16" rx="8" fill="url(#flute-grad)" stroke="#FFD700" stroke-width="2"/>
            <!-- बांसुरी के छेद -->
        ...
        <!-- ग्रेडिएंट परिभाषाएं -->
        <defs>
            <linearGradient id="flute-grad" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style="stop-color:#ffe680;stop-opacity:1" />
                <stop offset="50%" style="stop-color:#b38600;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#806000;stop-opacity:1" />
            </linearGradient>
        </defs>
    </svg>
</div>
"""
st.markdown(krishna_svg_art, unsafe_allow_html=True)
